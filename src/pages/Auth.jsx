...
export const Auth = () => {
  ...
  const handleRegistration = async (e) => {
    ...
    try {
      ...
      await auth?.register(userName, password, tagline, name);
      toast.success("User Registered Successfully", { id: "register" });
      navigate("/");
    } catch (e) {
      console.log(e);
      toast.error("User Registration Failed", { id: "register" });
    }
  };
        ...
        >
          ...
          >
            ...
            >
              ...
              <CustomizedInput type="text" name="tagline" label="Tagline" />
